...
namespace BaseSim2021
{
    ...
    public static class GameController
    {
        ...
        {
            MessageBox.Show("Nouvel effet actif : " + indexedValue.ToString());
        ...
        {
            MessageBox.Show("Fin de l'action de : " + indexedValue.ToString());
        ...
        public static void LoseDialog(IndexedValue indexedValue)
        {
            ...
            theView.WriteLine("Partie perdue." +
                (indexedValue==null ? " Dette insurmontable." : indexedValue.CompletePresentation()));
            theView.Refresh();
            theView.EnableNextButton(false);
        }
        /// <summary>
        ...
        {
            MessageBox.Show("Desactivation effectuée pour " + gCost + " gloire.");
